    ...
    return (
        <>
            <div className="p-0 bg-amber-300">
                ...
                <div className="grid grid-cols-4 h-[85vh] md:grid-cols-4 lg:grid-cols-4 gap-1 lg:gap-1">
                    <div className="p-1 col-span-4 bg-cyan-400 rounded-md flex"><ViewerAps docUrn={docUrn} api={api} handleChangeToken={handleChangeToken} /></div>
